...
urlpatterns = [
    ...
    path('editar-amostra/', views.editar_amostra, name='editar-amostra'),
    path('visualizar-experimento/<int:id_experimento>/', views.visualizar_experimento, name='visualizar-experimento')
]
